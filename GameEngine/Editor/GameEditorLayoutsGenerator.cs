...
namespace PlayStationGames.GameEngine.Editor
{
    public class GameEditorLayoutsGenerator: EditorLayoutsGenerator<GameField, Game, GameFieldGroup>
    {
        ...
        public override short Top(GameField field) => 
            field switch
            {
                GameField.Licensed =>
        ...
        public override short Left(GameField field) => 
            field switch
            {
                GameField.Image or 
                GameField.Verified =>
        ...
        public override short Height(GameField field) =>
            field switch
            {
                GameField.Image =>
                    110,
        ...
        public override short Width(GameField field) => 
            field switch
            {
                GameField.Image =>
                    200,
